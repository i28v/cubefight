...
cubefight: obj/Release/main.o obj/Release/Game.o obj/Release/Player.o obj/Release/Bullet.o obj/Release/Lehmer.o 
	$(CXX) $(CXXFLAGS) -o bin/Release/cubefight obj/Release/main.o obj/Release/Game.o obj/Release/Player.o obj/Release/Bullet.o obj/Release/Lehmer.o $(CXXLIBS)

obj/Release/main.o: src/main.cpp include/Game.h
	$(CXX) $(CXXFLAGS) -c src/main.cpp -o obj/Release/main.o $(CXXLIBS)

obj/Release/Game.o: include/data.h include/Game.h include/Player.h include/Bullet.h include/Lehmer.h
	$(CXX) $(CXXFLAGS) -c src/Game.cpp -o obj/Release/Game.o $(CXXLIBS)

obj/Release/Player.o: include/data.h include/Player.h include/Bullet.h obj/Release/Bullet.o
...
clean:
	rm bin/Release/cubefight obj/Release/main.o obj/Release/Game.o obj/Release/Player.o obj/Release/Bullet.o obj/Release/Lehmer.o
